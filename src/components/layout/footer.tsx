    ...
    <footer className="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 pt-12 pb-8">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="col-span-1">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
              AIを活用したトレンド分析と創作支援プラットフォーム。ZORAのCoins Protocolで簡単にトークン化できます。
            </p>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/dashboard" className="text-gray-600 hover:text-primary-600 dark:text-gray-400 dark:hover:text-primary-400">
                  トレンド分析
                </Link>
              </li>
              <li>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3">
              <li>
                <a href="https://zora.co" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-primary-600 dark:text-gray-400 dark:hover:text-primary-400 flex items-center">
                  <span>ZORA</span>
              ...
              <li>
                <a href="https://base.org" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-primary-600 dark:text-gray-400 dark:hover:text-primary-400 flex items-center">
                  <span>Base</span>
                  <svg className="ml-1 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"></path>
                  </svg>
        ...
        <div className="border-t border-gray-200 dark:border-gray-800 pt-6 text-center text-sm text-gray-600 dark:text-gray-400">
          <p className="mb-2">&copy; {new Date().getFullYear()} Coinspire. All rights reserved.</p>
          <p>Powered by ZORA Coins Protocol on Base.</p>
        </div>
      </div>
    </footer>
  );
